...
export const InfoIcon = ({ className }: SVGProps<SVGElement>) => {
  return (
    <svg
      width="32"
      height="32"
...
export const MenuIcon = ({ className }: SVGProps<SVGElement>) => {
  return (
    <svg
      className={className}
      width="32"
...
export const KnifeIcon = ({ className }: SVGProps<SVGElement>) => {
  return (
    <svg
      width="56"
      height="56"
    ...
    >
      ...
      <g clipPath="url(#clip0_53782_59)">
        <g clipPath="url(#clip1_53782_59)">
          <path
...
export const CupIcon = ({ className }: SVGProps<SVGElement>) => {
  return (
    <svg
      width="56"
      height="56"
